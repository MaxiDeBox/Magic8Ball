package ru.proweb63.magic8ball
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val shakeBallBtn: Button = findViewById(R.id.shakeBallBtn)

        shakeBallBtn.setOnClickListener{ shakeBall() } // лямбда выражение
    }

    private fun shakeBall() {
        val ballIV: ImageView = findViewById(R.id.imageBallIV)

        var randomChoice = Random().nextInt(20) + 1
        ...
        ballIV.setImageResource(imageResource)
    }
}